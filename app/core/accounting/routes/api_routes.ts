...
const V8ObservabilityController = () => import('#core/common/controllers/v8_observability_controller')
...
router.post('/health/v8/heap-snapshot', [V8ObservabilityController, 'heapSnapshot']).as('health.v8.heapSnapshot')
router.post('/health/v8/cpu-profile', [V8ObservabilityController, 'cpuProfile']).as('health.v8.cpuProfile')
